...
Обратное преобразование сложнее, например если требуется выполнить обновление объекта (метод PATCH), то нужно по id
...
Попытка обновления сложного объекта со вложенными объектами через MapStruct приведет к использованию `cascade`
